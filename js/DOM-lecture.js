...
let changeText = document.createElement("my-list1")

changeText.innerText = "Hello Buddy"

console.log(changeText.innerText)



let changeTexto = document.createElement("my-list2")

changeTexto.innerHTML = "Hello Buddette"

console.log(changeTexto.innerHTML)
