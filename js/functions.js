...
// //     sayHello("Rigoberto");
// //     console.log(sayHello("Rigoberto" ));
// //     sayHello("Rigoberto");
...
// function calcualteTip(tip, billTotal){
//     return tip * billTotal;
//     }
//
//     console.log(calcualteTip( .20, 33.35));
//     console.log(calcualteTip(.15, 12.00).toFixed());
//     console.log(calcualteTip(.25, 25.50).toFixed());
// //     nameYourFunction(20, 5);
// //
// //
